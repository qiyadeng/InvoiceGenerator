...
<body>
    <div id="loading" style="position: fixed;top: -50%;left: -50%;width: 200%;height: 200%;background: #fff;z-index: 100;overflow: hidden;">
        ...
        <span style="position: absolute;top: 0;left: 0;right: 0;bottom: 0;margin: auto;">电子发票管理系统</span>
    </div>
    <div id="index_layout">
        ...
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright power by qiya.tech<a href="http://www.baidu.com" target="_blank"></a></div>
    </div>
