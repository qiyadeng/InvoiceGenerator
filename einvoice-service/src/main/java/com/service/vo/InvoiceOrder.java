...
public class InvoiceOrder {
    ...
    private String gmf_phone;
    private String bmbbbh;//版本号
    private String tax_spbm;//商品编码
    ...
    public String getGmf_phone() {
        return gmf_phone;
    }

    public void setGmf_phone(String gmf_phone) {
        this.gmf_phone = gmf_phone;
    }
