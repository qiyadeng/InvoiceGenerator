...
public interface EinvoiceBodyDao extends CrudRepository<EinvoiceBody, Long>{
    ...
    //根据发票查询流水号关联
    @Query(nativeQuery = true,value = " select * from einvoice_body where dr=0 and fpqqlsh=:fpqqlsh ")
    public List<EinvoiceBody> getByFpqqlsh_einvoicehead(@Param("fpqqlsh")String fpqqlsh);
